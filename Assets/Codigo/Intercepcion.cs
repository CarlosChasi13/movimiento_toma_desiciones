...
public class Intercepcion : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float magnitudVelRelativa = velRelativa.magnitude;
        if (magnitudVelRelativa > 0)
        {
            tiempoIntercepcion = distanciaRelativa.magnitude / magnitudVelRelativa;
        }
        else
        {
            tiempoIntercepcion = 0;
        }
